...
export default function PartnersSection() {
  ...
  return (
    <Flex align={"center"} flexDirection={"column"} py={"40px"} gap={"40px"}>
      <Text fontSize={"14px"}>Powering the next generation B2B startups</Text>
      <VStack gap={"32px"}>
        <SimpleGrid columns={4} row={2} spacing={"16px"} w={"100%"} maxW={"880px"}>
        ...
        <Box
          ...
          maxW={"1000px"}
          h={"1px"}
          background={"radial-gradient(70.71% 70.71% at 50% 50%, rgba(149, 149, 155, 0.40) 0%, rgba(230, 230, 230, 0.00) 100%)"}
          boxShadow={
